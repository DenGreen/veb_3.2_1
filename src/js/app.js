export class Character {
  ...
  set stoned(value){
    if (value.type === "Magician" || value.type === "Daemon"){
     return value.attack = value.attack - Math.log2(value.distance) * 5;
    } else {
      throw Error(`Нельзя применить данную способность к классу ${value.type}`);
    }
